<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="planList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="专业名" align="center" prop="dept.name"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="课程名" prop="courseId">
          ...
          <el-select v-model="form.courseId" multiple remote filterable size="medium"
                     default-first-option multiple placeholder="请输入课程名"
          >
            <el-option
